...
X_train = housing_not_missing[['longitude', 'latitude', 'housing_median_age', 'total_rooms',
                               'population', 'households', 'median_income', 'median_house_value',
                               '1h_ocean', 'island', 'inland', 'near_ocean',
                               'near_bay']]  # data  (X) -> longitude, latitude, total_rooms, population, households, median_house_value
...
minmax_housing = minmax_scaler.fit_transform(housing)
minmax_housing = pandas.DataFrame(minmax_housing,
                                  columns=['longitude', 'latitude', 'housing_median_age', 'total_rooms',
                                           'total_bedrooms',
                                           'population', 'households', 'median_income', 'median_house_value',
                                           '1h_ocean',
